...
<br>
<form action ="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method ="POST" id="adduser" class="smart-green">
...
<label>
<span> E-mail : </span>
<input type="text" name="mail" placeholder="nitc e-mail id">
</label>
<label>
...
<label>
<span> Current Quarter ID : </span>
<input type="text" name="quarterid"/>
</label>
<br>
<label>
<span>&nbsp;</span>
<input type=submit class="button" value="Add User" name="addu">
</label>
</form>
...
else
{
	if(isset($_POST["addu"]))
	{
		...
		$sql = "INSERT INTO user (name,mail,dob,designation,doj,basic,grade,quarterid)
		VALUES ('$name','$mail','$dob','$designation','$doj','$basic','$grade','$quarterid')";

		if ($conn->query($sql) === TRUE) 
		{
    		$message = "New User $name Added";
    		echo "<script type='text/javascript'>alert('$message');</script>";
		} 
		else 
		{
	    	//$message = "ERROR : User $name Not Added";
    		//echo "<script type='text/javascript'>alert('$message');</script>";
